class Carousel extends React.Component {
    constructor(props){
        ...
        this.state = {
            pictures: ['/img/landing-page.png', '/img/carousel6.png', '/img/carousel2.png', '/img/added-carousel.png', '/img/added-carousel3.png', '/img/added-carousel4.png', '/img/added-carousel5.png', '/img/added-carousel6.png'],
