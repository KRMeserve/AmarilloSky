    ...
    render(){
        return(
            <div>
                ...
                <p><span class="bold">Drummer:</span> Pearl Custom Session, Ludwig and Yamaha 5 pc. drum kits (depending on venue), Rolls personal in-ear monitor system, Alesis drum sampler, and an EV microphone and stand. He sings lead and backup harmonies throughout the show.</p>
