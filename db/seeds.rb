...
INSERT INTO members (name, instrument, img, bio) VALUES ('Tanner "The Voice" Smale', 'Lead Vocals', '/img/tanner.png', 'Tanner was born and raised in Elkhart, IN. Finding an affinity early on for performing, he has been singing for large crowds since 8th grade. Tanner later received a degree in Musical Theatre from North Central College in Naperville, IL. Following his education, Tanner worked as a professional actor in the Chicago region for a time before proposing to his high school sweetheart and planting his roots in South Bend, IN. Beginning in 2013, Tanner now works Premier Arts, a local community theatre organization located Downtown Elkhart, as an Acting Instructor and Scenic Artist.
...
started playing music in Middle School. Rob has been playing the Bass ever since and
has played with multiple bands and enjoys all different genres. Rob plays Gibson Basses
...
on with Tanner, Rob and Jerry with Amarillo Sky.');
SELECT * FROM members;
